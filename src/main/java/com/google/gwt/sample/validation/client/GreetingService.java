...
public interface GreetingService extends RemoteService {
    ...
    Address getAddress(String id) throws IllegalArgumentException, ConstraintViolationException;

    String saveAddress(Address address) throws IllegalArgumentException, ConstraintViolationException;

    /**
     * Force hibernate validator imple1metations to be available for serialization.
     */
